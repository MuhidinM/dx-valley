...
const Page = () => {
  ...
  <Card
    ...
    buttonText={"Visit Site"}
    buttonText2={"Read More"}
    description='A reconciliation platform by Coop Bank of Oromia automates and simplifies the process of matching transactions with bank statements. It enhances accuracy, streamlines financial operations, and reduces administrative tasks, ensuring efficient and transparent financial management.'
    href={" "}
  />
  <Card
    img={<SVG1 />}
