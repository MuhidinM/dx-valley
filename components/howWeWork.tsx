      ...
      <section className='relative py-10 lg:py-20'>
        <div className='container mx-auto py-10'>
...

          {
            works.map((item, indx) => (
              indx % 2 == 0 ? (
                <div key={indx} className='grid grid-cols-1 lg:grid-cols-2 items-center justify-center md:items-center md:justify-center    '>
              ...
              :
              (
                <div key={indx} className='grid grid-cols-1 lg:grid-cols-2 items-center justify-center my-20'>
