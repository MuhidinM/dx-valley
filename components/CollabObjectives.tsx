import { BrainCircuitIcon, RocketIcon, UsersIcon, TrendingUpIcon } from "lucide-react"
...
const objectiveItems: ObjectiveItem[] = [
  {
    ...
    content: "Facilitate expertise and industry insights to build strong foundations.",
    icon: <BrainCircuitIcon className="w-6 h-6" />,
    color: "text-blue-600"
  },
  {
    title: "Skill Development",
    content: "Enhance practical skills through targeted workshops and training.",
        ...
        <div className="flex flex-wrap justify-center gap-6">
          {objectiveItems.map((item, index) => (
            <div key={index} className="flex flex-col items-center w-[220px]">
              <div className={`w-12 h-12 mb-3 rounded-full bg-gray-100 ${item.color} flex items-center justify-center`}>
                {item.icon}
              </div>
