            ...
            <div className="w-full max-w-6xl mx-auto">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12">
                    ...
                    <div className="flex flex-col items-center space-y-4">
                        ...
                        <div className="text-center text-lg font-medium text-gray-800">Description 2</div>
                    </div>

                    {/* Objective 3 */}
                    <div className="flex flex-col items-center space-y-4">
                        <div className="w-20 h-20 bg-gradient-to-r from-red-400 to-pink-500 text-white flex items-center justify-center rounded-lg shadow-lg">
                            <svg className="w-10 h-10" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                <path strokeLinecap="round" strokeLinejoin="round" d="M15 10a3 3 0 01-6 0 3 3 0 016 0zm2 6a6 6 0 01-12 0 6 6 0 0112 0zm1.5-9.5a1.5 1.5 0 01-3 0 1.5 1.5 0 013 0zm-3 10a1.5 1.5 0 01-3 0 1.5 1.5 0 013 0zm6.5-7.5h-1a1.5 1.5 0 010-3h1a1.5 1.5 0 010 3zm-10 12.5h-1a1.5 1.5 0 010-3h1a1.5 1.5 0 010 3zm-12-1h1a1.5 1.5 0 010 3h-1a1.5 1.5 0 010-3zm3-19.5h-1a1.5 1.5 0 010-3h1a1.5 1.5 0 010 3z"></path>
                            </svg>
                        </div>
                        <div className="text-center text-lg font-medium text-gray-800">Description 3</div>
                    </div>
                    ...
                    <div className="flex flex-col items-center space-y-4">
                        <div className="w-20 h-20 bg-gradient-to-r from-yellow-400 to-orange-500 text-white flex items-center justify-center rounded-lg shadow-lg">
                            <svg className="w-10 h-10" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                <path strokeLinecap="round" strokeLinejoin="round" d="M13.414 10L18 14.586l-1.414 1.414L12 11.414l-4.586 4.586L6 14.586 10.586 10 6 5.414 7.414 4 12 8.586l4.586-4.586L18 5.414 13.414 10z"></path>
                            </svg>
                        </div>
                        <div className="text-center text-lg font-medium text-gray-800">Description 4</div>
                    </div>
                </div>
            </div>
        </div>
