    ...
    <div>
      ...
      <div className='w-94 mt-8 mb-8 dark:bg-gray-900  flex items-center justify-center'>
        <Card className='admin-event w-[900px]'>
          ...
          <CardContent>
        <div className="mb-4 text-center text-sm lg:text-lg md:block lg:block flex">
            ...
            {currentStep === 2 && (
              <form onSubmit={handleNext}>
                <div className='flex flex-row space-y-1.5 space-x-4'>
                  <Label>Bringing a team?</Label>
                  <Checkbox
            ...
            {currentStep === 3 && (
              <div>
                ...
                <div className='mb-4'>
                  <h3 className='lg:font-semibold text-sm '>Personal Info</h3>
                  <p>First Name: {formData.firstName}</p>
                  <p>Last Name: {formData.lastName}</p>
                  <p>Email: {formData.email}</p>
                  <p>Phone Number: {formData.phoneNumber}</p>
