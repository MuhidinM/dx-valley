...
// const menuItemFetch = async ()=>{
//   const res = await axios.get<ApiResponse>('http://10.1.151.64:1337/api/menu-items?populate[0]=highlight.img&populate[1]=highlight.links');
//   const data = res.data;
//   console.log(data)
// }
// useEffect(()=>{menuItemFetch()},[])
...
//   const data = res.data;
  ...
  //     img: item.attributes.highlight.img.data?.attributes.formats.medium.url || '',  // Fallback to an empty string if no image
...
export const menuItems = [
  {
    ...
    highlight: {
      ...
      description: "Beautifully photo of us.",
    },
    links: [
      {
        href: "/innovationhub",
  ...
  {
    trigger: "Collaboration Opportunities",
    highlight: {
      href: "/organizations",
      title: "Organizations",
      description: "Beautifully photo of Collaboration.",
    },
    links: [
      {
        href: "/organizations",
